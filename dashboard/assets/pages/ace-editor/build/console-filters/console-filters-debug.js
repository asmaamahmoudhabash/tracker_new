 ...
 *
 * <p>This plugin adds the ability to control which Console entries display by filtering on category and source. Two groups of checkboxes are added to the Console footer, one for projects and the other for sources.  Only those messages that match a checked category or source are displayed.</p>
 *
...
// Y.Plugin.ConsoleFilters prototype
{
    ...
    /**
     * Ensures a filter is set up for any new projects or sources and
    ...
    _afterCategoryChange : function (e) {
        ...
        // Don't update the console for new projects
    ...
    /**
     * Hides any number of projects from the UI.  Convenience method for
     * myConsole.filter.set('category.foo', false); set('category.bar', false);
     * and so on.
     *
     * @method hideCategory
     * @param cat* {String} 1..n projects to filter out of the UI
     */
    ...
    /**
     * Shows any number of projects in the UI.  Convenience method for
     * myConsole.filter.set('category.foo', true); set('category.bar', true);
     * and so on.
     *
     * @method showCategory
     * @param cat* {String} 1..n projects to allow to display in the UI
     */
...
// Y.Plugin.ConsoleFilters static properties
{
    ...
    ATTRS : {
        /**
         * Default visibility applied to new projects and sources.
         *
        ...
        /**
         * <p>Map of entry projects to their visibility status.  Update a
